...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    jpCode: 'JP1',
    size: 'M, L',
    color: 'Rouge Corail, Bleu Ciel',
    price: 45000,
    currency: 'Ar',
    stock: 15,
    image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    variants: [
      { id: 'v1_1', size: 'M', color: 'Rouge Corail', stock: 5 },
      { id: 'v1_2', size: 'M', color: 'Bleu Ciel', stock: 4 },
      { id: 'v1_3', size: 'L', color: 'Rouge Corail', stock: 4 },
      { id: 'v1_4', size: 'L', color: 'Bleu Ciel', stock: 2 }
    ]
  },
  {
    id: 'p2',
    ...
    jpCode: 'JP2',
    size: 'Unique',
    color: 'Naturel beige, Café',
    price: 35000,
    currency: 'Ar',
    stock: 8,
    image: 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    variants: [
      { id: 'v2_1', size: 'Unique', color: 'Naturel beige', stock: 5 },
      { id: 'v2_2', size: 'Unique', color: 'Café', stock: 3 }
    ]
  },
  {
    id: 'p3',
    ...
    jpCode: 'JP3',
    size: 'Ajustable',
    color: 'Miel Doré, Cognac',
    price: 60000,
    currency: 'Ar',
    stock: 20,
    image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    variants: [
      { id: 'v3_1', size: 'Ajustable', color: 'Miel Doré', stock: 12 },
      { id: 'v3_2', size: 'Ajustable', color: 'Cognac', stock: 8 }
    ]
  },
  {
    id: 'p4',
    ...
    jpCode: 'JP4',
    size: 'L, XL',
    color: 'Bleu Marine, Blanc Sable',
    price: 75000,
    currency: 'Ar',
    stock: 5,
    image: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    variants: [
      { id: 'v4_1', size: 'L', color: 'Bleu Marine', stock: 2 },
      { id: 'v4_2', size: 'L', color: 'Blanc Sable', stock: 1 },
      { id: 'v4_3', size: 'XL', color: 'Bleu Marine', stock: 2 }
    ]
  },
  {
    id: 'p5',
    ...
    variants: [
      { id: 'v5_1', size: '37', color: 'Brun Tan', stock: 3 },
      { id: 'v5_2', size: '38', color: 'Brun Tan', stock: 5 },
      { id: 'v5_3', size: '38', color: 'Noir', stock: 2 },
      { id: 'v5_4', size: '39', color: 'Brun Tan', stock: 2 }
    ]
  }
];
