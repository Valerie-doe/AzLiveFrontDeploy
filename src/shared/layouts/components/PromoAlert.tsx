...
export default function PromoAlert({ onShowGuide }: PromoAlertProps) {
  return (
    <div className="bg-secondary text-primary text-[11px] font-sans md:text-xs py-2 px-4 text-center flex items-center justify-center gap-2 border-b border-secondary font-medium w-full">
