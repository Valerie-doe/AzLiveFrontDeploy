  ...
  return (
    <div className="space-y-6" id="product-management-panel">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-black text-secondary tracking-tight font-sans">Le Dressing & Codes JP</h2>
        ...
        {!isAdding && !editingId && (
          <button
            ...
            className="px-4.5 py-2.5 bg-secondary hover:bg-accent text-primary rounded-xl text-xs font-black uppercase tracking-wider flex items-center gap-1.5 self-start sm:self-auto transition-colors cursor-pointer border-none"
          >
