...
import { getProductDisplay, formatPrixUnitaire } from '../../products/utils/productUtils';
            ...
            >
              ...
              {(() => {
                ...
                return activeProds.map((p) => {
                  ...
                  return (
                  <option key={p.id} value={primaryJp}>
                    {primaryJp} - {p.name} ({formatPrixUnitaire(display.prixUnitaire)})
                  </option>
                )});
              })()}
            </select>
