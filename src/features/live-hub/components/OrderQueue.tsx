...
import { findVariantByJpCode } from '../../products/utils/productUtils';
        ...
        <div className="space-y-4 max-h-[600px] overflow-y-auto pr-1">
          <AnimatePresence initial={false}>
            {orders.map((ord) => {
              ...
              const jpVariant = findVariantByJpCode(products, ord.jpCode);
              const isOutOfStock = jpVariant ? (jpVariant.stock < positionInQueue) : false;
