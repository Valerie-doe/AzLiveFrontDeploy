    ...
    <div className="space-y-6 flex-1 flex flex-col justify-between">
      ...
      <div className="pt-4 border-t flex flex-col gap-2">
        ...
        <button
          ...
          className="w-full py-2 px-4 bg-slate-900 border border-slate-900 hover:bg-slate-800 text-white font-extrabold rounded-xl text-xs uppercase transition-colors cursor-pointer text-center flex items-center justify-center gap-1.5 shadow-sm"
        >
